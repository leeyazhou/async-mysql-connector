...
public class AsyncCallTest {
	...
	public void testExecute() throws Exception {
		...
		final String url = AsyncCall.enable("jdbc:mysql://10.100.216.147:3306/flower");
		final Connection connection = DriverManager.getConnection(url, "root", "UJ9FeAm3Yc@#E%IH8dLj6guyr5K&u#J3");
		final PreparedStatement preparedStatement = connection
				.prepareStatement("select 'hello async-mysql-connector!'");
	...
	protected void selectTable(Connection connection)
			throws SQLException, InterruptedException, java.util.concurrent.ExecutionException {
	...
	private void createTable(Connection connection)
			throws SQLException, InterruptedException, java.util.concurrent.ExecutionException {
		Statement statement = connection.createStatement();
		Future<Integer> future = AsyncCall.asyncUpdate(statement,
				"CREATE TABLE IF NOT EXISTS T1 (a int, b int, c int, PRIMARY KEY(a))");
	...
	private void selectFromDual(Connection connection)
			throws SQLException, InterruptedException, java.util.concurrent.ExecutionException {
		Statement statement = connection.createStatement();
